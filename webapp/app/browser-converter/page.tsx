...
export default function BrowserConverterPage() {
  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    try {
      ...
      if (isRar) {
        setError('True RAR files require the Python script. Most CBR files are ZIP-based and work here. Please download the Python script for RAR files.');
        setStatus('error');
        return;
      }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Convert CBR files entirely in your browser - no server needed!
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              ✨ Works with files of any size • No upload limits • 100% client-side
            </p>
          </div>
          ...
          <div className="mt-8 text-center space-y-2">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">
              Note: Works with ZIP-based CBR files. For true RAR files, use the <a href="/download-script" className="text-blue-600 hover:underline">Python script</a>.
            </p>
            <div className="mt-4">
              <a
                href="/"
              ...
              >
                ← Back to server-based converter
              </a>
            </div>
          </div>
        </div>
